...
Ob=function(a){if(/* QUICKFIX:
		...
		*/
i.modal&&a.preventDefault(),F){var b=e.arraySearch(lb,a.pointerId,"id");if(b>-1){var c=lb[b];c.x=a.pageX,c.y=a.pageY}}if(U){var d=Lb(a);if(fa||X||_)$=d;else{if(sb.x!==sa.x*qa)
